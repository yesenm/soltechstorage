                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" id="desc">Permiso 1</th>
                                <th scope="col">Permiso 2</th>
                                <th scope="col">Permiso 3</th>
                                <th scope="col">Permiso 4</th>
                                <th scope="col">Permiso 5</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        ...
                                        <label id="labelP" class="custom-control-label" for="customRadioInline1">Permitido</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                                        <label id="labelP" class="custom-control-label" for="customRadioInline2">No permitido</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="custom-control custom-radio custom-control-inline">
