...
<body>
    ...
    <br>
        <form id="BPForm" class="rounded-3 form_search" action="buscar_venta.php" method="get">
            ...
            <a href="ventasreg.php"><button class="btn btn-warning" type="button"><i class="fas fa-book-open"></i></button></a>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <?php
                        ...
                        $sql_registe= ("SELECT * FROM ventasregis
                        WHERE (invoice_id LIKE '%$busqueda%' OR
                        cashier_name LIKE '%$busqueda%' OR
                        order_date LIKE '%$busqueda%' OR
