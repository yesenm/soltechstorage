    ...
    <center>
        ...
        <?php 
            ...
            <form id="BPForm" class="rounded-3 form_search" action="buscar_gasto.php" method="get">
                ...
                <input id="buspro" value="<?php echo $busqueda; ?>" type="text" name="busqueda" placeholder="Buscar gasto" aria-label="Search" class="rounded-3">
                <button class="btn btn-success btn_search" type="submit" value="Buscar"><i class="fas fa-search"></i></button>
                <a href="gastos.php"><button class="btn btn-warning" type="button"><i class="fas fa-book-open"></i></button></a>
                ...
                <div class="table-responsive">
                    <table class="table" id="inv">
                        ...
                        <?php
                                ...
                                $sql_registe= ("SELECT * FROM gastos
                                    WHERE (id LIKE '%$busqueda%' OR
                                    empleado LIKE '%$busqueda%' OR
                                    rubro LIKE '%$busqueda%' OR
                                    fecha LIKE '%$busqueda%' OR
                                    proyecto LIKE '%$busqueda%' OR
