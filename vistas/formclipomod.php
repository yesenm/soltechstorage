...
<head>
    ...
    <title>Edicion de clientes potenciales</title>
    ...
    <form id="PForm" class="rounded-3" method="POST"
		action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <fieldset>
                ...
                <label>Nombre</label>
                <input type="text" class="form-control" placeholder="Nombre" name="nombrepo" id="nombrepo" value="<?php echo $consulta[1];?>" class="rounded-3"/><br>
                <label>Teléfono</label>
                <input type="text" class="form-control" placeholder="Teléfono" name="telefonopo" id="telefonopo" value="<?php echo $consulta[2];?>" class="rounded-3"/><br>
                <label>Dirección</label>
                <input type="text" class="form-control" placeholder="Dirección" name="direccionpo" id="direccionpo" value="<?php echo $consulta[3];?>" class="rounded-3"/><br>
                <label>Correo</label>
                <input type="text" class="form-control" placeholder="Correo" name="correopo" id="correopo" value="<?php echo $consulta[4];?>" class="rounded-3"/><br>
                <label>RFC</label>
