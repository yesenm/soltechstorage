                      ...
                      <label class="form-check-label" for="flexRadioDefault1">
                        ...
                        <script>
                          $('#radio1').click(function(){
                            ...
                            input1+='<br><br>';
                            input1+=`<butto class="btn btn-info cambiar" id="cambiarCliente" value="Cambiar tipo de cliente">Cambiar tipo de cliente</button>`;
                            input1+='</div>';
                            input1+='</div>';
                      ...
                      <label class="form-check-label" for="flexRadioDefault2">
                        ...
                        <script>
                          $('#radio2').click(function(){
                            ...
                            input2+=`<select class="form-control clientepo" name="clientepo"required><option value="A">Selecciona</option><?php 
                            ...
                            input2+='<br><br>';
                            input2+='<input type="button" class="btn btn-info" id="cambiarCliente" value="Cambiar tipo de cliente">';
                            input2+='</div>';
                            input2+='</div>';
                      ...
                      <label class="form-check-label" for="flexRadioDefault1">
                        ...
                        <script>
                          $('#radio3').click(function(){
                            ...
                            input3+=`<select class="form-control clientecr" name="clientecr"required><option value="A">Selecciona</option><?php 
                            ...
                            input3+='<br><br>';
                            input3+='<input type="button" class="btn btn-info" id="cambiarCliente" value="Cambiar tipo de cliente">';
                            input3+='</div>';
                            input3+='</div>';
                ...
                <table class="table table-border" id="myOrder">
                  ...
                  <tbody>
                    ...
                    $('#btn_addOrder').click(function(){
                      ...
                      html+=`<td><input type="hidden" class="form-control codigoi_" name="codigoi_[]" readonly></td>`;
                      html+=`<td><select class="form-control id_" name="id_[]" style="width:100px;" required><option value="">Selecciona</option><?php 
                        $consulta ="SELECT * FROM inventario";
                        $ejecutar = mysqli_query($conexion, $consulta) or die (mysqli_error($conexion)); ?>
                        <?php foreach ($ejecutar as $opciones):?>
                        <option value="<?php echo $opciones['id']; ?>"><?php echo $opciones['codigoi']; ?></option>
